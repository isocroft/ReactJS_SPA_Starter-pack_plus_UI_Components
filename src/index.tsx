...
import {
  EventBusProvider /*, SharedGlobalStateProvider */,
} from "react-busser";
...
import type { FeatureFlagEnvs } from "./shared/providers/FeaturesToggleProvider";
...
root.render(
  <React.StrictMode>
    <FeaturesToggleProvider
      ...
      environment={config.ENV as FeatureFlagEnvs}
      authUserOptions={{
        "[identifier]": "id",
