...
export default function BrowserEventToasts({
  ...
  useEffect(() => {
    ...
    const onCopy = (event: Event) => {
      ...
      if (srcElement.hasAttribute("data-clipboard-object")) {
        showToast({
          title: "User Action",
    ...
    const onPrintingErrored = () => {
      showToast({
        title: "User Action",
        description: "Oops! An error occured while printing",
      });
      console.info(
        `printing this page (${document.title}) resulted in an error`
      );
    };
    const onBeforePrintStart = () => {
      showToast({
        title: "User Action",
        description: "Please wait... Print dialog will appear shortly!",
      });
      console.info(
        `printing this page (${document.title}) is just about to start`
      );
    };
    ...
    const onAfterPrintEnd = () => {
      if (printingStarted) {
        showToast({
          title: "User Action",
          description: "All done with printing!",
        });
        ...
        showToast({
          title: "User Action",
          description: "Printing was canceled!",
        });
    ...
    const onOnline = () => {
      showToast({
        ...
        description: "You are now re-connected to the internet!",
      });
    };
    const onOffline = () => {
      showToast({
        title: "Network Connectivity",
        description: "You seem to not be connected to the internet!",
      });
    };
